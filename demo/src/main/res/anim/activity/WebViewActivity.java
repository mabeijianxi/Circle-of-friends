        ...
        switch (v.getId()) {
            ...
            case R.id.detail_for_help:
                if (!TextUtils.isEmpty(appGoodsChooseInfor.storeTelephone)) {
                    CommonUtils.showPhoneDialog(WebViewActivity.this, appGoodsChooseInfor.storeTelephone);
                } else {
                    toast("请咨询当地服务站");
                }
                break;
            case R.id.detail_add_card:
                if (UserSharedPreferencesUtil.getUserLoginState(WebViewActivity.this) < 2) {
                    CommonUtils.startLoginActivity(WebViewActivity.this);
                }
                isAddCard = true;
            ...
            case R.id.iv_title_bar_right:
                CommonUtils.startGoodsCartActivity(WebViewActivity.this);
            ...
            public void onSuccess(ResponseInfo<String> responseInfo, String requestTag) {
                if (Constant.MallUrl.COMMODITY_PROPS.equals(requestTag)) {
                    ...
                    if (baseBean.code == 100) {
                        int num = SharedPreferencesUtil.getIntData(WebViewActivity.this, Constant.ShouYeUrl.SHAOPPING_NUM, 0) + 1;
//                        CommonUtils.setRedDotNum(goodsCard, num);
                        SharedPreferencesUtil.saveIntData(WebViewActivity.this, Constant.ShouYeUrl.SHAOPPING_NUM, num);
                        toast(baseBean.msg);
                    } else {
                        toast(baseBean.msg);
                    }
//                    toast(responseInfo.result);
                    ...
                    BaseBean<Object> baseBean = JsonUtil.jsonArray(responseInfo.result, Object.class);
                    if (baseBean.code == 100) {
                        SharedPreferencesUtil.saveStringData(WebViewActivity.this, Constant.CachTag.APP_COMMDITY_GOODS_CART_SUBMMIT, responseInfo.result);
                        Intent intent = new Intent(WebViewActivity.this, CommoditySettlementActivity.class);
//                        intent.putExtra(CommodityGoodsCardListActivity.CURRENTSUBMMITCARDIDS, currentSubmmitCardIds);
            ...
            public void onFailure(HttpException error, String msg, String requestTag) {
                NetWorkStateUtils.errorNetMes(WebViewActivity.this);
            }
        };
    }
